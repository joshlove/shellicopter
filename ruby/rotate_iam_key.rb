#!/usr/bin/env ruby
#used for rotating IAM keys for all items in a credetials file.
#I typically just use this in cron with the reboot flag so I auto update 
...
config.groups.each do |group|
  ...
  resp = iam.get_access_key_last_used({access_key_id: config.params[group]['aws_access_key_id'],})
